...
?>
                                        <div id="desc" class="infos <?= isset($goodUpload) && $goodUpload == false ? 'd-none' : '' ?>">
                                            <ul>
                                                ...
                                                <li class="social">
                                                    <a class="<?= $user['USER_TWITTER'] ? 'show twitter' : 'none' ?>" href="<?= $user['USER_TWITTER'] ?? '' ?>" target="_blank"><i class="bi bi-twitter"></i></a>
                                                    <a class="<?= $user['USER_YOUTUBE'] ? 'show youtube' : 'none' ?>" href="<?= $user['USER_YOUTUBE'] ?? '' ?>" target="_blank"><i class="bi bi-youtube"></i></a>
                                                    <a class="<?= $user['USER_TWITCH'] ? 'show twitch' : 'none' ?>" href="<?= $user['USER_TWITCH'] ?? '' ?>" target="_blank"><i class="bi bi-twitch"></i></a>
                                                </li>
                                            </ul>
                                        </div>
